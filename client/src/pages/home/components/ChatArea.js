    ...
    <div className="bg-white h-[82vh] border rounded-2xl w-full flex flex-col justify-between p-5">
      ...
      <div className="h-18 rounded-xl border-gray-300 shadow border flex justify-between p-2 items-center relative">
        ...
        <div className="flex gap-2 text-xl">
          ...
          <i className="ri-bold cursor-pointer text-lg text-blue-500"></i>
          <i className="ri-strikethrough cursor-pointer text-lg"></i>
          <i className="ri-code-s-slash-line cursor-pointer text-lg"></i>
          <i className="ri-links-line cursor-pointer text-lg"></i>
          <i className="ri-at-line cursor-pointer text-lg"></i>
          <i
